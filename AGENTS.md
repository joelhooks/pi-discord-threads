...
- Do not mutate LaunchAgent state, call `launchctl`, flip `releases/current`, or restart the live daemon unless the user explicitly asks for deploy/operator action.
